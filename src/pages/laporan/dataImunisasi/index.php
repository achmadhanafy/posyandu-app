...
<div>
 ...
 <hr />
 <p style="text-align: center;font-size:24px;margin-top:24px;">Laporan Pelayanan Imunisasi</p>
 <div style="padding: 24px;">
  <?php
  $headerData = array('ID Balita', 'Nama Balita', 'Tanggal Lahir', 'Nama Ibu', 'Alamat', 'Imunisasi', 'Catatan', 'Tgl Imunisasi');
  $rowData = $data['getIbuHamil'];
  include '../src/components/laporan/tableImunisasi.php'
  ?>
 </div>
