<div>
 ...
 <hr />
 <p style="text-align: center;font-size:24px;margin-top:24px;">Laporan Pendaftaran Ibu Hamil</p>
 <div style="padding: 24px;">
  <?php
  $headerData = array('NIK', 'Nama', 'Tanggal Lahir', 'Tanggal HPL', 'Faskes', 'Alamat', 'Nama Suami', 'No Hanphone');
