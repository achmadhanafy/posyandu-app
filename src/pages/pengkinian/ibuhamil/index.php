  ...
  <div class="flex ml-5 flex-col justify-center items-center w-full">
    <div style="width: 100%;" class="mr-5">
      ...
      <div style="width: 100%;" class="border-2 border-secondary-40 rounded-lg p-5">
        ...
        <?php endif; ?> -->
        <div class="font-semibold text-xl mb-3 text-secondary-40 text-center">Pengkinian Ibu Hamil</div>
        ...
        <?php if ($data['action'] != 'ubah' && $data['action'] != 'hapus' && $data['getIbuHamil'] !== false) : ?>
          <?php
          $headerData = array('NIK', 'Nama', 'Tanggal Lahir', 'Tanggal Hpl', 'Faskes', 'Alamat', 'Nama Suami', 'No Hp', 'Action');
          $rowData = $data['getIbuHamil'];
          include '../src/components/tableIbuHamil.php'
          ?>
        <?php endif; ?>
        <?php if ($data['getIbuHamil'] == false) : ?>
